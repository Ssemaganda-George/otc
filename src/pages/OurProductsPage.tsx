          ...
          <div className="container mx-auto px-6">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-card border border-border rounded-2xl p-8 shadow-card">
                <h3 className="text-2xl font-playfair font-semibold text-gradient-blue mb-8">
                  Litigation Database
                </h3>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border">
                        ...
                        <th className="text-left py-4 px-4 text-sm font-semibold text-foreground">Case Name</th>
                        <th className="text-left py-4 px-4 text-sm font-semibold text-foreground">Issues</th>
                        <th className="text-left py-4 px-4 text-sm font-semibold text-foreground">Country</th>
                        <th className="text-left py-4 px-4 text-sm font-semibold text-foreground">Year of Filing</th>
                        <th className="text-left py-4 px-4 text-sm font-semibold text-foreground">Status</th>
                      </tr>
                    </thead>
                    <tbody>
                      {litigationCases.map((case_) => (
                        <tr key={case_.caseNumber} className="border-b border-border/50">
                          <td className="py-4 px-4 text-sm text-muted-foreground">{case_.caseNumber}</td>
                          <td className="py-4 px-4 text-sm text-foreground font-medium">{case_.caseName}</td>
                          <td className="py-4 px-4 text-sm text-muted-foreground">{case_.issues}</td>
                          <td className="py-4 px-4 text-sm text-muted-foreground">{case_.country}</td>
                          <td className="py-4 px-4 text-sm text-muted-foreground">{case_.yearFiled}</td>
                          <td className="py-4 px-4 text-sm text-muted-foreground">{case_.status}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
