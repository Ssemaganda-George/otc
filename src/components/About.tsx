				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-16">
						...
						<p className="text-body text-muted-foreground max-w-3xl mx-auto">
							We are Africa's premier technology law firm, bridging the gap
							between innovation and regulation to create an enabling environment
							for digital transformation across the continent.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
						...
						<div className="card-dark p-8 shadow-card hover:shadow-golden transition-all duration-300 card-hover">
							...
							<p className="text-body text-gray-300 leading-relaxed text-justify sm:text-left">
								An Africa where innovation and digital transformation advance human
						...
						<div className="card-dark p-8 shadow-card hover:shadow-golden transition-all duration-300 card-hover">
							...
							<p className="text-body text-gray-300 leading-relaxed text-justify sm:text-left">
								To drive inclusive digital transformation in health, sexual and
								reproductive health, finance, agriculture, and development across
								Africa while safeguarding fundamental human rights and advancing
								social justice through research, training, advocacy, and innovation.
							</p>
						</div>
					</div>
					...
					<div className="mt-20">
						<div className="text-center mb-8">
							...
							<p className="text-body text-gray-300 max-w-3xl mx-auto">
								Our comprehensive approach to advancing Africa's digital
								transformation through integrated legal, technological, and social
								justice initiatives.
							</p>
						</div>
						...
						<div className="max-w-5xl mx-auto space-y-8">
							...
							>
								<div className="bg-golden p-6 text-center shadow-golden transition-all duration-300 hover:shadow-lg hover:scale-[1.02] group-hover:animate-glow-pulse">
									<h4 className="text-xl md:text-2xl font-bold text-dark-text leading-tight">
										THE OTC FRAMEWORK ON TECH, INNOVATION & DIGITALISATION IN
										AFRICA
									</h4>
								</div>
								{/* Connecting Arrow */}
								<div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-golden opacity-60 animate-flow-line"></div>
							</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
								{[
									{
										title: "HEALTH & SRHR",
										desc: "Sexual & Reproductive Health Rights",
										icon: Heart,
									},
									{
										title: "AGRICULTURE",
									...
									{
										title: "FINANCE",
										desc: "FinTech & Governance",
										icon: Briefcase,
									},
									{
										title: "DEVELOPMENT",
										desc: "Digitalization & Growth",
										icon: Target,
									},
								].map((sector, index) => (
									<div
									...
									>
										...
										<div className="hidden md:block absolute top-full left-1/2 transform -translate-x-1/2 w-0.5 h-6 bg-golden/40 opacity-40"></div>
									</div>
								))}
							</div>
							...
							<div className="relative flex justify-center">
								...
								>
									<div className="bg-golden p-8 text-center shadow-golden transition-all duration-500 hover:shadow-lg hover:scale-105 max-w-md group-hover:animate-glow-pulse">
							...
							<div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
								{[
									...
									>
										...
										<div className="hidden md:block absolute -top-6 left-1/2 transform -translate-x-1/2 w-0.5 h-6 bg-golden opacity-40 animate-flow-line"></div>
										<div
											className={`card-dark border-2 ${dept.color} rounded-xl p-4 text-center shadow-card transition-all duration-300 hover:shadow-golden hover:border-golden hover:scale-105 group-hover:animate-glow-pulse`}
										>
							...
							>
								{/* Connecting Arrow */}
								<div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-golden opacity-60 animate-flow-line"></div>
								<div className="bg-golden-light/80 border-2 border-golden/50 p-6 text-center shadow-golden transition-all duration-300 hover:shadow-lg hover:scale-[1.01] group hover:animate-glow-pulse">
									<h4 className="text-lg md:text-xl font-bold text-dark-text mb-2">
										"Transformation that Promotes Human Rights and Justice for
										All in Africa"
									</h4>
									<p className="text-sm text-dark-muted">
										Our ultimate goal: An Africa where technology drives
										inclusive prosperity and social justice
									</p>
								</div>
							</div>
						</div>
					...
					<div className="mt-24 bg-dark-card/50 rounded-3xl p-12">
						<div className="text-center mb-16">
							...
							<p className="text-body text-gray-300 max-w-3xl mx-auto">
								We operationalize the OTC Framework through our four (4)
								strategic pillars
							</p>
						</div>
							...
							{[
								...
								>
									<div className="card-dark border-2 border-golden/20 rounded-xl p-6 shadow-card transition-all duration-300 hover:shadow-golden hover:border-golden/40 h-[380px] flex flex-col">
										<h5 className="text-lg font-semibold text-white mb-6 pb-3 border-b border-golden/30">
											{pillar.title}
										</h5>
						...
						<div className="card-dark border-2 border-golden/20 p-8 text-center shadow-card">
							...
							<p className="text-lg text-gray-300 leading-relaxed max-w-4xl mx-auto">
								<span className="font-semibold text-golden">Connectivity:</span>{" "}
								Building technologies and systems that seamlessly connect people,
								communities, and innovations across Africa.
							</p>
						</div>
					</div>
				</div>
