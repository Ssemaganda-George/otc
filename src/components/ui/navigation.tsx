                      ...
                      <div className="py-2">
                        {item.dropdown.map((dropdownItem) => (
                          <Link
                            ...
                            className="block px-4 py-3 text-lg text-blue-700 hover:text-golden hover:bg-secondary/50 transition-colors duration-200"
                          >
                            {dropdownItem.name}
                          </Link>
                        ))}
                        ...
                        <div className="ml-4 mt-2 space-y-2 bg-secondary/30 rounded-lg p-3">
                          {item.dropdown.map((dropdownItem) => (
                            <Link
                              key={dropdownItem.name}
                              to={dropdownItem.href}
                              className="block py-2 text-lg text-blue-700 hover:text-golden transition-colors duration-200"
                              onClick={() => {
