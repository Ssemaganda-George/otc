...
INSERT INTO repositories (title, description, category, language, stars, forks, last_updated, github_url, demo_url, tags, thumbnail, is_active) VALUES
('OneTechConnect Digital Rights Framework', 'A comprehensive framework for assessing and protecting digital rights in African contexts, with tools for policy analysis and advocacy.', 'Assessment Tools', 'Python', 45, 12, '2024-12-20', 'https://github.com/otc-africa/digital-rights-framework', 'https://demo.otc-africa.org/digital-rights', ARRAY['digital-rights', 'policy', 'advocacy', 'africa'], '/assets/repos/digital-rights-framework.jpg', true),
('AI Ethics Assessment Toolkit', 'Open-source toolkit for evaluating AI systems against African ethical standards and human rights frameworks.', 'AI Ethics', 'JavaScript', 78, 23, '2024-12-18', 'https://github.com/otc-africa/ai-ethics-toolkit', 'https://demo.otc-africa.org/ai-ethics', ARRAY['ai', 'ethics', 'assessment', 'human-rights'], '/assets/repos/ai-ethics-toolkit.jpg', true),
('Blockchain Compliance Checker', 'Automated tool for checking blockchain implementations against regulatory compliance requirements in African jurisdictions.', 'Compliance Tools', 'Go', 32, 8, '2024-12-15', 'https://github.com/otc-africa/blockchain-compliance', 'https://demo.otc-africa.org/blockchain-compliance', ARRAY['blockchain', 'compliance', 'regulation', 'finance'], '/assets/repos/blockchain-compliance.jpg', true),
('Digital Justice Case Database', 'Comprehensive database of digital justice cases from across Africa, with search and analysis tools for legal professionals.', 'Case Management', 'TypeScript', 67, 19, '2024-12-12', 'https://github.com/otc-africa/digital-justice-db', 'https://demo.otc-africa.org/digital-justice-db', ARRAY['database', 'legal', 'cases', 'justice'], '/assets/repos/digital-justice-db.jpg', true),
('Open Data Portal Template', 'Template for creating open data portals with built-in privacy protection and data sovereignty features.', 'Data Portal', 'React', 54, 16, '2024-12-10', 'https://github.com/otc-africa/open-data-portal', 'https://demo.otc-africa.org/open-data-portal', ARRAY['open-data', 'portal', 'privacy', 'sovereignty'], '/assets/repos/open-data-portal.jpg', true);