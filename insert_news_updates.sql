-- SQL script to insert the hardcoded news content back into the database
-- Run this in Supabase SQL Editor or via Supabase CLI

-- Temporarily disable RLS for news_updates table to allow inserts
...
-- Insert the hardcoded news content
...
-- Re-enable RLS for news_updates table
ALTER TABLE news_updates ENABLE ROW LEVEL SECURITY;

-- Verify the inserts
SELECT id, title, is_featured, category FROM news_updates ORDER BY created_at DESC LIMIT 10;
